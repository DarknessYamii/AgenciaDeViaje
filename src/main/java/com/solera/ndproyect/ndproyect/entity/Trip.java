...
public class Trip implements Serializable{
	...
	public String toString() {
		return "Trip [flight_id=" + flight_id + ", idAirline=" + idAirline + ", from=" + from + ", dest=" + dest
	...
	public Trip(long flight_id, long idAirline, String from, String dest, boolean scale, boolean luggage,
